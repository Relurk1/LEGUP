...
public class ConditionalContradictionRuleTest {
    ...
    @Test
    public void falseConditional() throws InvalidFileFormatException{
        TestUtilities.importTestBoard("puzzles/shorttruthtable/rules/ConditionalContradictionRule/falseConditional",stt);
        ...
        for(ShortTruthTableCellType i:types){
            for(ShortTruthTableCellType j:types){
                ...
                if(i.equals(ShortTruthTableCellType.TRUE) && j.equals(ShortTruthTableCellType.FALSE)){
    ...
    @Test
    public void trueConditional() throws InvalidFileFormatException{
        TestUtilities.importTestBoard("puzzles/shorttruthtable/rules/ConditionalContradictionRule/trueConditional",stt);
        TreeNode rootNode = stt.getTree().getRootNode();
        TreeTransition transition = rootNode.getChildren().get(0);
        transition.setRule(RULE);
