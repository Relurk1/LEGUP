...
public class AtomicCaseRuleTest {
    ...
    public void caseRuleTest() throws InvalidFileFormatException{
        TestUtilities.importTestBoard("puzzles/shorttruthtable/rules/AtomicCaseRule/caseRuleTest",stt);
        ...
        ShortTruthTableCellType cellType1 = board1.getCell(1,0).getType();
        ShortTruthTableCellType cellType2 = board2.getCell(1,0).getType();

        Assert.assertFalse(cellType1.equals(cellType2));
