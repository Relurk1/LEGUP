...
public class BiconditionalCaseRuleTest {
    ...
    public void caseRuleTest() throws InvalidFileFormatException{
        TestUtilities.importTestBoard("puzzles/shorttruthtable/rules/BiconditionalCaseRule/caseRuleTest",stt);
        ...
        ShortTruthTableCellType cellType2 = board2.getCell(2,0).getType();
